...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--summary-csv",
        type=Path,
        default=METADATA_DIR / "pose_sequence_summary.csv",
        help="Input pose_sequence_summary.csv file.",
    )
    parser.add_argument(
        "--output-csv",
        type=Path,
        default=METADATA_DIR / "pose_sequence_quality_by_exercise.csv",
        help="Output CSV for per-exercise quality summary.",
    )
    parser.add_argument(
        "--worst-csv",
        type=Path,
        default=METADATA_DIR / "pose_sequence_quality_worst_cases.csv",
